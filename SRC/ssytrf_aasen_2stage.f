*> \brief \b SSYTRF_AASEN_2STAGE
*
* @generated from SRC/dsytrf_aasen_2stage.f, fortran d -> s, Mon Oct 30 11:57:50 2017
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download SSYTRF_AASEN_2STAGE + dependencies
...
*> \verbatim
*>
*> SSYTRF_AASEN_2STAGE computes the factorization of a real symmetric matrix A
...
*
      IF( INFO.NE.0 ) THEN
         CALL XERBLA( 'SSYTRF_AASEN_2STAGE', -INFO )
         RETURN
      END IF
*
*     Answer the query
*
      NB = ILAENV( 1, 'SSYTRF_AASEN_2STAGE', UPLO, N, -1, -1, -1 )
      IF( INFO.EQ.0 ) THEN
         IF( TQUERY ) THEN
            TB( 1 ) = (3*NB+1)*N
         END IF
